...
from xplore.models import NavigationMenu, Service
...
@register.inclusion_tag('tags/submenu.html', takes_context=True)
def submenu(context, page):
    subpages = page.get_children().live().in_menu()
    fatherpage = page.get_ancestors().last()
    return {
